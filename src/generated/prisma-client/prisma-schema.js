...
type User {
  ...
  email: String!
  password: String!
  posts(where: LinkWhereInput, orderBy: LinkOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Link!]
}
...
input UserCreateInput {
  ...
  email: String!
  password: String!
  posts: LinkCreateManyWithoutAuthorInput
}
...
input UserUpdateInput {
  ...
  email: String
  password: String
  posts: LinkUpdateManyWithoutAuthorInput
}
...
input UserWhereInput {
  ...
  posts_every: LinkWhereInput
  posts_some: LinkWhereInput
  posts_none: LinkWhereInput
  AND: [UserWhereInput!]
  OR: [UserWhereInput!]
  NOT: [UserWhereInput!]
}
